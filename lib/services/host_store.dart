...
class HostStore {
  ...
  Host _decryptHost(Host host, [void Function(String id)? onCorrupt]) {
    ...
    // copyWith always allocates a fresh instance (HiveObject instances cannot
    // live in two boxes at once) and preserves fields this class doesn't know
    // about; plain ?? stored keeps the historical plaintext fallback for
    // unmarked values.
    return host.copyWith(password: plain ?? stored);
  }
